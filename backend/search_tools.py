...
class CourseSearchTool(Tool):
    ...
    def _format_results(self, results: SearchResults) -> str:
        ...
        for doc, meta in zip(results.documents, results.metadata):
            ...
            # Track source for the UI (label::url format)
            source = course_title
            if lesson_num is not None:
...
class CourseOutlineTool(Tool):
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": "Retrieve the complete outline of a course: its title, link, and full lesson list with lesson numbers and titles",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_title": {
                        "type": "string",
                        "description": "The course title to look up (partial matches work)"
                    }
                },
    ...
    def execute(self, course_title: str) -> str:
        ...
        # Track the course as a source for the UI
        source = outline['title']
        if outline.get('course_link'):
            source += f"::{outline['course_link']}"
